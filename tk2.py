...
def mainm():
    ...
    filename = PhotoImage(file ="election.png")
    background_label = Label(top, image=filename)
    background_label.place(x=0, y=0, relwidth=1, relheight=1)
    C.pack()
    L= Label(top, text = "Constituency Feedback System",fg='magenta2',font='Helvetica 18 bold')
    L.pack( side = TOP)
    
    L19= Label(top, text = "Welcome to the portal.Select the options to continue !!",bg='azure',fg='orange red',font='Helvetica 12 bold')
    ...
    B = Button(top, text = "Rate", command =new,activeforeground="Brown",fg='red',bg='navajo white',activebackground="Grey",relief=RAISED)
    B.place(x = 150,y = 150)

    B = Button(top, text = "Report", command = ne,activeforeground="Brown",fg='brown',bg='misty rose',activebackground="Grey",relief=RAISED)
    B.place(x = 300,y = 150)  
    
    B7= Button(top, text = "Exit",command=ex,activeforeground="Brown",bg='lightblue',activebackground="Grey",relief=RAISED)
    B7.place(x = 450,y = 350)
    
    def adm():
        top.destroy()
        admin2()
    B11 = Button(top, text = "Admin", command = adm,activeforeground="Red",fg='blue',bg='seashell2',activebackground="Grey",relief=RAISED)
